...
1.  Upload your data
    ...
    The input data for the BCG App must be uploaded using the `BCG_template.xlsx` file available [here](https://drive.google.com/drive/folders/1NK-roMmX4expx41YB1n3LS23rr94RWgf){target="_blank"}. In this Excel file, there are specific instructions on how to prepare the data.
